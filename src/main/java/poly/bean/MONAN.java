...
public class MONAN {
	...
	public MONAN(int idMon, String tenMon, String hinhAnh, String moTa, int idLoai,  int id_ND, int idCongThuc, int trangThai) {
		this.idMon = idMon;
		this.tenMon = tenMon;
	...
	public String toString() {
		return "MONAN [idMon=" + idMon + ", tenMon=" + tenMon + ", hinhAnh=" + hinhAnh + ", moTa=" + moTa + ", idLoai="
				+ idLoai + ", id_ND=" + id_ND + ", idCongThuc=" + idCongThuc + ", trangThai=" + trangThai  + "]";
	}
