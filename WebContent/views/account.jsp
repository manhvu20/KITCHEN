				...
				<ul class="navbar-nav mx-auto">
					...
					<li class="nav-item dropdown">
					  ...
					  <ul class="dropdown-menu" >
						<li><a class="dropdown-item" href="users/DanhMucMonAn.jsp">Danh Mục Món Ăn</a></li>
						<li><a class="dropdown-item" href="users/GoiYHomNay.jsp">Gợi Ý Hôm Nay</a></li>
						<li><a class="dropdown-item" href="users/TimKiemMonAn.jsp">Tìm Kiếm Món Ăn</a></li>
						<li><a class="dropdown-item" href="users/MonAnPhoBien.jsp">Món Ăn Phổ Biến</a></li>
						<li><a class="dropdown-item" href="users/DanhSachYeuThic.jsp">Danh Sách Yêu Thích</a></li> 
						<li><a class="dropdown-item" href="users/TaoMonAn.jsp">>Tạo Món Ăn</a></li>
					  </ul>
					</li>
    ...
    <main>
        ...
        <div id="content" class="profile">
            ...
            <div id="name">
                ...
                <br>
                <span style="color: f8f6f2; font-size: 16px;">@user123</span><br><br>
                <a href="Page.html"><button>Xem Trang Bếp</button>
            </div>
            <div id="profile-icon">
