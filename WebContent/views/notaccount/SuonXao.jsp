...
<body>
    <header>
	 	<nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="menu">
				...
				<div>
	                <button class="login-btn"><a aria-curent="location" href="/KITCHEN/views/login.jsp">Đăng Nhập</a></button>
	            </div>
	    	</div>
    ...
    <div class="container py-5">
        <div class="row">
                ...
                <div class="col-md-9">
                    <div class="card">
                        <img class="meal-detail card-img" src="https://goeco.link/ZRylO">
                    </div>
                    ...
                    <div class="card-detail">
                        <h2 class="center">Cách Làm Sườn Xào Chua Ngọt</h2>
                        <h3>Nguyên Liệu</h3>
                        <h4>- 120 sữa chua</h4>
