	 	...
	 	<nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="menu">
				...
				<!--	<li><a class="dropdown-item" href="#">Gợi Ý Hôm Nay</a></li> 	-->
						...
						<li><a class="dropdown-item" href="mon_an_pho_bien.jsp">Món Ăn Phổ Biến</a></li>
				...
				<div>
	                <button class="login-btn">
	                	<a aria-curent="location" href="/KITCHEN/views/login.jsp">Đăng Nhập</a>
	                </button>
	            </div>
	    	</div>
            ...
            <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="image-container">
                            <div class="card">
                                <img class="meal-image card-img" src="https://bitly.li/xsnX" alt="Banner Image">
                                <div class="Name-meal">
                    ...
                    <div class="col-md-4">
                        <div class="image-container">
                            <div class="card">
                                <img class="meal-image card-img" src="https://bitly.li/1g0z" alt="Banner Image">
                                <div class="Name-meal">
                                    <h5>Cơm Gà Mơ</h5>
                    ...
                    <div class="col-md-4">
                        <div class="image-container">
                            <div class="card">
                                <img class="meal-image card-img" src="https://bitly.li/mZr1" alt="Banner Image">
                                <div class="Name-meal">
