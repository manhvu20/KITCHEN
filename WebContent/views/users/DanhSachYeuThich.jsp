				...
				<ul class="navbar-nav mx-auto">
					...
					<li class="nav-item dropdown">
					  ...
					  <ul class="dropdown-menu" >
						...
						<li><a class="dropdown-item" href="GoiYHomNay">Gợi Ý Hôm Nay</a></li>
						...
						<li><a class="dropdown-item" href="DanhSachYeuThich">Danh Sách Yêu Thích</a></li> 
						<li><a class="dropdown-item" href="TaoMonAn">Tạo Món Ăn</a></li> 	
					  </ul>
					</li>
    ...
    <main>
        ...
        <div class="container py-5">
            <div class="row">
                    ...
                    <h1 class="text-center">Danh sách các món đã lưu</h1>
                    <div class="col-md-4">
                        <div class="image-container">
                            <div class="card">
                                ...
                                <div class="Name-meal">
                                    ...
                                    <div class="btn"></div>
                                    <a href="SuonXao.jsp"><button class="btn-view" type="button">Xem</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
