    ...
    <header>
	 	<nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="menu">
				<ul class="navbar-nav mx-auto">
					...
					<li class="nav-item dropdown">
					  ...
					  <ul class="dropdown-menu" >
						...
						<li><a class="dropdown-item" href="GoiYMonAn.jsp">Gợi Ý Hôm Nay</a></li>
				...
				<div>
	                <button class="login-btn"><a aria-curent="location" href="/KITCHEN/views/account.jsp">Tài Khoản</a></button>
	            </div>
	    	</div>
